...
Another thing to highlight is the Embeed layer, althouth the documentation is very scarce about this type of layer I think I managed to make it work correctly, this layer will specify the input dimensions to 250 this will be our total vocabulary and the expanded vector of 50 as specified by the output property, this means that this layer will store on a blob a matrix of 250 by 50, and will do a lookup operation for each index in our vocabulary.
