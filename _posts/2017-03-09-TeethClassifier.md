...
In Python I will create two clases, one for OpenCV face detection and one for DLib face detection. These clases will receive an input image and will return the area of the face but not the entire face just the bottom part.
